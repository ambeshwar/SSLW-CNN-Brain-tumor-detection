...
[FileName,PathName] = uigetfile('*.jpg;*.png;*.bmp','Graph Based Image');
...
IDM = double(in_diff); % IDM - Inverse Difference Movement
...
img2 = im2bw(I);
axes(handles.axes2)
imshow(img);title('Graph Based Detection');
 %imwrite(img,'temp17.jpeg')
 imwrite(img,'temp18.jpeg')
handles.ImgData2 = img2;
guidata(hObject,handles);
signal1 = img2(:,:);
[cA1,cH1,cV1,cD1] = dwt2(signal1,'db4');
